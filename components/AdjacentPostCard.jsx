...
const AdjacentPostCard = ({ post, position }) => (
  <>
    ...
    {position === 'LEFT' && (
      <div className='absolute arrow-btn bottom-5 text-center py-3 cursor-pointer bg-zinc-800 left-4 rounded-full'>
        <svg
    ...
    {position === 'RIGHT' && (
      <div className='absolute arrow-btn bottom-5 text-center py-3 cursor-pointer bg-zinc-800 right-4 rounded-full'>
        <svg
          xmlns='http://www.w3.org/2000/svg'
          className='h-6 w-6 text-white w-full'
          fill='none'
